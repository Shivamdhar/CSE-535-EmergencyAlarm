...
public class StaticKeys {
    ...
    public final static String VIBRATE_KEY = "vibrate_check";
    public final static String FLASH_SCREEN_KEY = "flash_screen_check";
    public final static String FLASH_LIGHT_KEY = "flash_light_check";
